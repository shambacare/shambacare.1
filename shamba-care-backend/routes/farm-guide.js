...
const { Farm, Task, CropActivity } = require('../models');
...
router.post('/crop-health', verifyToken, async (req, res) => {
    try {
        ...
        await Farm.update({ health_score: healthScore }, { where: { id: crop_id } });
